...
bot.start(async (ctx) => {
  try {
    ...
    await ctx.reply(
      ...
      Пользователь самостоятельно несёт полную ответственность за соблюдение законодательства страны, на территории которой используются файлы конфигурации и сервис в целом. Использование файлов конфигурации должно осуществляться строго в соответствии с действующими правовыми нормами государства пребывания.
